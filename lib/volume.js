...
document.addEventListener("DOMContentLoaded", () => {
    ...
    button2.onclick = () => { update(button2.dataset.chile) }

    const button3 = document.getElementById('clickme-3')
    button3.onclick = () => { update(button3.dataset.mexico) }

    const button4 = document.getElementById('clickme-4')
    button4.onclick = () => { update(button4.dataset.peru) }
    ...
    function update(selectedVar) {
        ...
        d3.csv("https://github.com/jeanyang0519/Hello-Avocado/blob/master/data/volume.csv", function (data) {
